...
export default class TableEditing extends Plugin {
	...
	init() {
		...
		schema.register( 'table', {
			allowWhere: '$block',
			allowAttributes: [ 'headingRows', 'headingColumns', 'border', 'class' ],
			isLimit: true,
			isObject: true,
			isBlock: true
		} );
		...
		schema.register( 'tableRow', {
			allowIn: 'table',
			allowAttributes: [ 'border', 'class'  ],
			isLimit: true
		} );

		schema.register( 'tableCell', {
			allowIn: 'tableRow',
			allowAttributes: [ 'colspan', 'rowspan', 'border', 'class'  ],
			isLimit: true
		} );
		...
		// conversion.attributeToAttribute( { model: 'border', view: {
			// '1': {classes: 'hide'},
			// '0': {classes: 'hide'}
	// }
		...
		editor.commands.add( 'addBorders', new BorderCommand( editor, { direction: 'add' } ) );
		editor.commands.add( 'removeBorders', new BorderCommand( editor, { direction: 'remove' } ) );
