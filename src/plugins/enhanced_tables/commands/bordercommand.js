...
export default class BorderCommand extends Command {
	...
	constructor( editor, options ) {
		 ...
		 */
		this.isHorizontal = this.direction == 'add' || this.direction == 'remove';
	}
	...
	execute() {
		...
		model.change( writer => {
			const isMergeNext = direction == 'add' || direction == 'remove';
			...
			let attribute = direction=="add" ? "show" : "hide";
			console.log(attribute, "attribute")
			writer.setAttribute( 'border', attribute, findAncestor( 'table', doc.selection.getFirstPosition() ) );
			writer.setAttribute( 'border', attribute, findAncestor( 'tableRow', doc.selection.getFirstPosition() ) );
			writer.setAttribute( 'border', attribute, cellToExpand );
	...
	_getMergeableCell() {
		const model = this.editor.model;
		const doc = model.document;
		console.log(findAncestor( 'table', doc.selection.getFirstPosition() ))
		const tableCell = findAncestor( 'tableCell', doc.selection.getFirstPosition() );
